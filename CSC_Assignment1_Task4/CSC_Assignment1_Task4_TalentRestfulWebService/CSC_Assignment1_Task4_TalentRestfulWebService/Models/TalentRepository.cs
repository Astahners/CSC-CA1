using CSC_Assignment1_Task4_TalentRestfulWebService.Interfaces;
using System;
    ...
    public class TalentRepository : ITalentRepository
    {
        ...
        public TalentRepository()
        {
            ...
            talents.Add(new Talent
            {
                ...
                Bio = "The Artist to Watch in 2012 by the London Review, Jonathan has already sold one of the highest priced-commissions paid to an art student, ever on record. The piece, entitled Gratitude Resort, a work in oil and mixed media, was sold for $750,000 and Jonathan donated all the proceeds to Art for Peace, an organization that provides college art scholarships for creative children in developing nations"
            });
